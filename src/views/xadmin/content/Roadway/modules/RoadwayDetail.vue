      ...
      <a-form :form='form' v-bind="formItemLayout" @submit='handleSubmit'>
        <a-col>
          <a-form-item  label="巷道名称" name='a'>
            ...
            <a-input v-model='formList.wkName' disabled></a-input>
          </a-form-item>
        </a-col>
        <a-col>
        ...
        <a-col>
          <a-form-item   label="采长/宽(m)">
            <a-input v-model='formList.miningLong' disabled></a-input>
          </a-form-item>
        </a-col>
        <a-col>
          <a-form-item  label="走向长/长(m)">
            <a-input v-model='formList.strikeLen' disabled></a-input>
          </a-form-item>
        </a-col>
