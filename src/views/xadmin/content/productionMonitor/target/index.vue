        ...
        <a-col class="table-wrapper">
          <a-table
            ...
            <template slot='operation' slot-scope="text, record" >
              <a class="operation" @click="bindModel(record)">指标填报</a>
            </template>
          </a-table>
        </a-col>
      </a-row>
...
export default {
  ...
  mounted () {
    getFillingSysList({ key: 'getTargetMonitorList' }).then(res => {
      console.log('res', res)
        ...
        list: [
          {
            ...
            type: 'input',
            required: true,
            placeholder: '请输入计划总产量'
          },
          {
            title: '计划总进尺',
            type: 'input',
            required: true,
            placeholder: '请输入计划总进尺'
          },
          {
            title: '计划日产量',
            type: 'input',
            required: true,
            placeholder: '请输入计划日产量'
          },
          {
            title: '计划日进尺',
            type: 'input',
            required: true,
            placeholder: '请输入计划日进尺'
          }
        ]
      }
      this.visible = true
